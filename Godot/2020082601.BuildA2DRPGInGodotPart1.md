...
让我们回到**MainScene**，测试一下移动。从FileSystem中，将player场景拖入场景窗口，它会创建一个实例。接着点击**Play**按钮，选择**MainScene**做为默认场景，然后看看移动是否正常工作。
...
回到**MainScene**，选择TileMap节点，再到inspector里，为**Tile set**属性，选择**load**。选择我们刚刚创建的**tileset.tres**，tiles将出现在右则的面板里。

![](https://www.colorgamer.com/usr/uploads/2020/08/3680495133.png)

现在，我们可以选择一个tile，再将它铺到场景里。下面是构建tilemap的一些按键：
...
![](https://www.colorgamer.com/usr/uploads/2020/08/4110569000.png)
 ...
 现在，如果我们尝试放置一颗树，你会发现它替换了tile，而不是放置它的上面。要解决这个问题，我们可以创建第二个tilemap。
