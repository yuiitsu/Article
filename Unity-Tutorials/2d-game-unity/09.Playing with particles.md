[< 前一篇](https://github.com/yuiitsu/Article/blob/master/Unity-Tutorials/2d-game-unity/08.Parallax%20scrolling.md)
...
> **单例**：单例是一个设计模式，用以保证一个对象只实例化一次。我们在脚本中与经典的实现略有不同：然后，原则仍然在。

1. 在"Hierarchy"里创建一个对象，命名为"Scripts"。
...
我们已经学习了如何使用Unity内置引擎创建粒子，正如你看到的，非常简单，而且它们增加了快乐和反馈到你的游戏里。
